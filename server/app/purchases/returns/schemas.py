"""Wire models for the purchase-return API (S1.6, ticket #12).

The client sends only the ORIGINAL purchase line ids + returned quantities —
...
purchase's payment methods proportionally; when present it must reconcile to
the return total like a purchase.
"""
